...
namespace Hardwhere_API.Controllers
{
    ...
    public class SupplyController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            var components = await _repository.GetAllComponentsIncluding<Supply>(x => x.IdComponentsNavigation);
            ...
            foreach (var listsupplysDTO in components)
            {
                var readAllComponentsDto = new ReadSearchDTO
                {
                    ...
                    Id = listsupplysDTO.IdComponentsNavigation.Id,
                    UrlImg = listsupplysDTO.UrlImg,
                    Type = listsupplysDTO.IdComponentsNavigation.Type
